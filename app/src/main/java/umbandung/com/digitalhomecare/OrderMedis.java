...
//        setSupportActionBar(toolbar);
        ...
        das = mySharedPrefernce.getValue(OrderMedis.this);
    ...
    private void getListTransaction(final String accesstoken) {
        ...
        try {
//            final String clinicID = mySharedPrefernce.getValueByKey(this, "KEY_CLINIC_ID");
//            Log.d("Order, clinic_id", mySharedPrefernce.getValueByKey(this, "KEY_CLINIC_ID"));
            //final String clinicID = "1"; //dev
            final String clinicID = das[10];
