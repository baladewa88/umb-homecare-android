...
public class OrderHistoryRecyclerView extends RecyclerView.Adapter<OrderHistoryRecyclerView.ViewHolder> {
    public static String[] orderNumber, dateOrder, patientsName, statuss, transactionsID;
    MySharedPrefernce mySharedPrefernce;


    public OrderHistoryRecyclerView(List<String> pOrderNumbers,
    ...
    @Override
    public OrderHistoryRecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(OrderHistoryRecyclerView.ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(v.getContext(), OrderHistoryDetail.class);
